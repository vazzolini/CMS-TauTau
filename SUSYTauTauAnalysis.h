...
public :
   ...
   //------------- new branch-----
   //   TBranch        *b_TauCounter;    //!
   //   TBranch        *b_TauHadCounter;    //!
...
// used to generate this class and read the Tree.
  if (tree == 0) {
    ...
    //      f = new TFile("/tmp/azzolini/TauTau/default_MC_16.root", "update"));   // lxplus255
  ...
  TFile *newfile = new TFile("/tmp/azzolini/TauTau/small.root","recreate");
...
void SUSYTauTauAnalysis::Init(TTree *tree)
{
   ...
   //------------- new branch-----
   //fChain->SetBranchAddress("TauCounter", &TauCounter, &b_TauCounter);
   //fChain->SetBranchAddress("TauHadCounter", &TauHadCounter, &b_TauHadCounter);
   //TBranch         *b_TauCounter = tree->Branch("TauCounter", &TauCounter, &b_TauCounter);
   //TBranch         *b_TauHadCounter = tree->Branch("TauHadCounter", &TauHadCounter, &b_TauHadCounter);
